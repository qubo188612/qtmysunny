...
#include "../qtmysunny/PictureBox.h"
...
void PictureBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PictureBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PictureBox::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PictureBox.data,
    qt_meta_data_PictureBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
